...
public class BigramCount extends Configured implements Tool {
  ...
  protected static class MyMapper extends Mapper<LongWritable, Text, Text, IntWritable> {
    ...
    public void map(LongWritable key, Text value, Context context)
      ...
      // write a working example by modifying code in here - start
      context.write(BIGRAM, ONE);
      // write a working example by modifying code in here - end
    }
  }
  ...
  protected static class MyReducer extends Reducer<Text, IntWritable, Text, IntWritable> {
    ...
    public void reduce(Text key, Iterable<IntWritable> values, Context context) throws IOException,
      ...
      // You can obtain int variable from IntWritable using get function.
      // For example, 
      // IntWritable writableInt = new IntWritable(10);
      // int value = writableInt.get();
